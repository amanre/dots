...
echo
		...
		echo
		cp $installed_dir/Personal/settings/arcolinux/xfce4-panel.xml ~/.config/xfce4/xfconf/xfce-perchannel-xml/xfce-panel.xml
		sudo cp $installed_dir/settings/arcolinux/xfce-panel.xml /etc/skel/.config/xfce4/xfconf/xfce-perchannel-xml/xfce-panel.xml
